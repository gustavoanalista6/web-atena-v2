...
<body>
    ...
    <div class="content">
        ...
        <p>O <strong>Centro Educacional HYARTE-ML</strong>, pessoa jurídica de direito privado, inscrita sob o CNPJ 01.429.030/0001-66, com sede e administração principal na Rua Euridamas Avelino de Barros, 1400, Bairro Prado, Paracatu-MG CEP 38602-002, doravante denominado simplesmente Instituição, atua como o Controlador dos dados pessoais coletados de seus alunos, responsáveis legais, docentes, colaboradores e demais usuários que interagem com seus serviços educacionais e plataformas digitais, responsabilizando-se pelo tratamento de dados pessoais conforme as disposições da <strong>Lei Geral de Proteção de Dados Pessoais (Lei nº 13.709/2018)</strong> e demais normas aplicáveis.</p>

        <p>O compromisso desta Instituição com a privacidade e a proteção dos dados pessoais é absoluto, sendo fundamental para a transparência e a construção de um ambiente de confiança mútua, respeitando a autodeterminação informativa dos titulares.</p>
